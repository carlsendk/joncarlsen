...
Ørsted, then DONG Energy, was running IT delivery in a way that made change slow
and hard to predict. The business wanted teams that could plan, commit, and ship
on a regular cadence, and it wanted that way of working to hold across the whole
IT department rather than in one or two pockets.
...
Ørsted moved to a common way of working across IT, with teams running SCRUM, a
shared estimation model, and an offshore development centre that extended
delivery capacity. The communities of practice kept the standards alive, so the
change held rather than fading once the project ended.
