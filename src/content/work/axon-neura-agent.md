...
put such an agent inside the product itself.

## What I did

I set up the team and built Neura, a GenAI agent embedded into AXON Networks'
products, working on top of the real-time telemetry the platform already
produces. I brought it into pre-sales as well, using it to show prospects what
agent-based, AI-driven operation looks like on their own data rather than as a
slide. It built on the AI/ML capability and the real-time pipelines we had stood
up for the platform.
