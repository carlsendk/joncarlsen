...
metrics:
  - "Organisation-wide Java to Go move"
order: 1.2
---
...
I built up a team to lead the move from Java to Go, starting with the services
that needed predictable performance. To bring the rest of the organisation along
I provided training and guides so teams could start building Go services
themselves instead of waiting for a central group, treating the shift as change
management rather than a one-off migration.
